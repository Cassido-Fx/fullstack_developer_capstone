...
class CarModelInline(admin.TabularInline):
    model = CarModel
    extra = 1  # Number of empty CarModel objects
    # displayed by default in the admin
...
class CarModelAdmin(admin.ModelAdmin):
    ...
    # Enable search by car model name or car make name


# CarMakeAdmin class: Custom admin class
# for CarMake, with CarModel inline
