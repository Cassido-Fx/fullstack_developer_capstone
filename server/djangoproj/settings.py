...
ALLOWED_HOSTS = ['localhost', 'https://okaforcassy-8000.theianext-0-'
                 'labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
# CSRF_TRUSTED_ORIGINS = ['https://okaforcassy-8000.theianext-0-labs-prod-misc-
# 'tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = [
    'https://okaforcassy-8000.theianext-1-'
    'labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai',
    'https://okaforcassy-8000.theianext-0-'
    'labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai',
    'https://okaforcassy-8000.theiadockernext-0-'
